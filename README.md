...
This project is an educational implementation of a decoder-only transformer, inspired by the paper [Attention Is All You Need](https://arxiv.org/abs/1706.03762).

Unlike the full encoder–decoder architecture described in the paper, the decoder-only transformer has become the standard architecture for causal language modeling and text generation tasks, as used in models like GPT.
...
](https://www.learnpytorch.io/) - refresh my understanding of modern PyTorch syntax and best practices
